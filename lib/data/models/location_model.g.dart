...
extension LocationModelQuerySortBy
  ...
  QueryBuilder<LocationModel, LocationModel, QAfterSortBy> sortByAddress() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'address', Sort.asc);
    });
  }

  QueryBuilder<LocationModel, LocationModel, QAfterSortBy> sortByAddressDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension LocationModelQuerySortThenBy
  ...
  QueryBuilder<LocationModel, LocationModel, QAfterSortBy> thenByAddress() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'address', Sort.asc);
    });
  }

  QueryBuilder<LocationModel, LocationModel, QAfterSortBy> thenByAddressDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'address', Sort.desc);
    });
  }
...
extension LocationModelQueryWhereDistinct
  ...
  QueryBuilder<LocationModel, LocationModel, QDistinct> distinctByAddress(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension LocationModelQueryProperty
  ...
  QueryBuilder<LocationModel, String?, QQueryOperations> addressProperty() {
    return QueryBuilder.apply(this, (query) {
